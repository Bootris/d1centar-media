...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.site-layout','data' => ['title' => __('media.blog.title'),'description' => __('media.blog.subtitle')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('media.blog.title')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('media.blog.subtitle'))]); ?>

    
    <section class="bg-navy-950 text-white">
        <div class="mx-auto max-w-[100rem] px-6 py-16 sm:py-20">
            <p class="text-xs font-semibold uppercase tracking-[0.22em] text-bronze-400"><?php echo e(__('media.blog.eyebrow')); ?></p>
            <h1 class="mt-3 font-display text-4xl font-black leading-none tracking-tight text-balance sm:text-7xl"><?php echo e(__('media.blog.title')); ?></h1>
            <p class="mt-5 max-w-xl text-navy-100"><?php echo e(__('media.blog.subtitle')); ?></p>
        </div>
    </section>
...
<?php endif; ?>
                <p class="mt-4 text-ink-600"><?php echo e(__('media.blog.empty')); ?></p>
            </div>
        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/d1centar-media/resources/views/blog/index.blade.php ENDPATH**/ ?>